...
replaceitem entity @a[tag=sr.player_atk,scores={sr:mh_weapon=6}] slot.hotbar 0 minecraft:netherite_sword 1 10000 {"item_lock":{ "mode":"lock_in_slot"},"keep_on_death":{}}

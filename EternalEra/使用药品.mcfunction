...
# #(连锁)#[2]
title @a[tag=shift,hasitem={slot=slot.weapon.mainhand,item=ghast_tear,data=507}] actionbar §7服用了§f感冒灵§7， 感觉好多了..
...
# #[2]
title @a[tag=shift,hasitem={slot=slot.weapon.mainhand,item=turtle_shell_piece,data=509}] actionbar §7服用了§f降火胃片§7， 感觉好多了..
...
# #[2]
title @a[tag=shift,hasitem={slot=slot.weapon.mainhand,item=feather,data=512}] actionbar §7使用了§f家用绷带§7， 感觉好多了..

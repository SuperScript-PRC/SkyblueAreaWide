...
execute as @e[tag=is.gravel,scores={is:random=5..6}] at @s run structure load 掉落物绿宝石 ~~~
execute as @e[tag=is.gravel,scores={is:random=7..13}] at @s run structure load 掉落物青金石 ~~~
execute as @e[tag=is.gravel,scores={is:random=14..24}] at @s run structure load 掉落物红石 ~~~
execute as @e[tag=is.gravel,scores={is:random=25..31}] at @s run structure load 掉落物粗金 ~~~
execute as @e[tag=is.gravel,scores={is:random=32..46}] at @s run structure load 掉落物粗铁 ~~~
execute as @e[tag=is.gravel,scores={is:random=47..55}] at @s run structure load 掉落物粗铜 ~~~
execute as @e[tag=is.gravel,scores={is:random=56..89}] at @s run structure load 掉落物煤炭 ~~~

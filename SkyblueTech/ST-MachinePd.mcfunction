...
# 电力挖石机=11
execute as @e[tag=st.machine,scores={st:mc_type=0,st:circuit=1..},hasitem={item=minecraft:flint,data=706}] at @s if block ~~-1~ minecraft:target [] if block ~~1~ minecraft:stonecutter_block [] run scoreboard players set @s st:mc_type 11
# 感应炉=12

...
# 配方: 铜锭-铜粉
execute as @e[scores={st:mc_type=2},hasitem={item=minecraft:copper_ingot,data=0,slot=0,quantity=1,location=slot.inventory}] run scoreboard players set @s st:runid_tmp 4
# 配方: 金锭-金粉
execute as @e[scores={st:mc_type=2},hasitem={item=minecraft:gold_ingot,data=0,slot=0,quantity=1,location=slot.inventory}] run scoreboard players set @s st:runid_tmp 5
# 配方: 锡锭-锡粉
execute as @e[scores={st:mc_type=2},hasitem={item=minecraft:iron_ingot,data=505,slot=0,quantity=1,location=slot.inventory}] run scoreboard players set @s st:runid_tmp 6
# 配方: 铅锭-铅粉
execute as @e[scores={st:mc_type=2},hasitem={item=minecraft:netherbrick,data=506,slot=0,quantity=1,location=slot.inventory}] run scoreboard players set @s st:runid_tmp 7
# 配方: 银锭-银粉
execute as @e[scores={st:mc_type=2},hasitem={item=minecraft:iron_ingot,data=508,slot=0,quantity=1,location=slot.inventory}] run scoreboard players set @s st:runid_tmp 8
# 配方: 镍锭-镍粉
execute as @e[scores={st:mc_type=2},hasitem={item=minecraft:copper_ingot,data=509,slot=0,quantity=1,location=slot.inventory}] run scoreboard players set @s st:runid_tmp 9
# 配方: 钴锭-钴粉
execute as @e[scores={st:mc_type=2},hasitem={item=minecraft:netherbrick,data=513,slot=0,quantity=1,location=slot.inventory}] run scoreboard players set @s st:runid_tmp 10
# 配方: 粗铁-2铁粉
execute as @e[scores={st:mc_type=2},hasitem={item=minecraft:minecraft:raw_iron,data=0,slot=0,quantity=1,location=slot.inventory}] run scoreboard players set @s st:runid_tmp 11
# 配方: 粗铜-2铜粉
execute as @e[scores={st:mc_type=2},hasitem={item=minecraft:raw_copper,data=0,slot=0,quantity=1,location=slot.inventory}] run scoreboard players set @s st:runid_tmp 12
# 配方: 粗金-2金粉
execute as @e[scores={st:mc_type=2},hasitem={item=minecraft:raw_gold,data=0,slot=0,quantity=1,location=slot.inventory}] run scoreboard players set @s st:runid_tmp 13
# 配方: 木炭-碳粉
execute as @e[scores={st:mc_type=2},hasitem={item=minecraft:charcoal,data=0,slot=0,quantity=1,location=slot.inventory}] run scoreboard players set @s st:runid_tmp 14
# 配方: 煤炭-碳粉
execute as @e[scores={st:mc_type=2},hasitem={item=minecraft:coal,data=0,slot=0,quantity=1,location=slot.inventory}] run scoreboard players set @s st:runid_tmp 14
# 感应炉
# 配方: 铁粉-铁锭
...
# 配方: 1x钢锭+1x镍锭-2x殷钢锭
execute as @e[scores={st:mc_type=12},hasitem={item=minecraft:iron_ingot,data=504,slot=0,quantity=1,location=slot.inventory}] if entity @e[y=~2,hasitem={item=minecraft:copper_ingot,data=509,slot=0,quantity=1,location=slot.inventory}] run scoreboard players set @s st:runid_tmp 2
# 配方: 1x铜锭+1x镍锭-2x康铜锭
execute as @e[scores={st:mc_type=12},hasitem={item=minecraft:copper_ingot,data=0,slot=0,quantity=1,location=slot.inventory}] if entity @e[y=~2,hasitem={item=minecraft:copper_ingot,data=509,slot=0,quantity=1,location=slot.inventory}] run scoreboard players set @s st:runid_tmp 3
# 配方: 1x铁锭+1x碳粉-1x钢锭
execute as @e[scores={st:mc_type=12},hasitem={item=minecraft:copper_ingot,data=0,slot=0,quantity=1,location=slot.inventory}] if entity @e[y=~2,hasitem={item=minecraft:black_dye,data=0,slot=0,quantity=1,location=slot.inventory}] run scoreboard players set @s st:runid_tmp 4
# 配方: 1x金锭+1x银锭-1x琥珀金锭
